		...
		<>
			<ul>
				{entries.map((entry, index) => (
					<li
						key={index}
						className="mb-2 flex cursor-pointer flex-col items-stretch rounded-md border-2 border-theme-border bg-theme-bg px-2 py-1 shadow-link last:mb-0"
					...
					>
						...
						<input
							...
							value={entry.value}
							readOnly
							className="rounded-md border-none bg-theme-input px-2 py-1 font-semibold outline-none"
						/>
					</li>
				))}
			</ul>
